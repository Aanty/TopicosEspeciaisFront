...
Além das informações tradicionais dos animais, o sistema também permite o cadastro de vídeos do YouTube para enriquecer a experiência visual e educativa da plataforma.
...
* **Cadastro de vídeos do YouTube** para cada animal
* **Visualização de vídeos** diretamente na aplicação após o cadastro
...
* **Player de vídeo integrado** para visualização dos animais
...
* **YouTube Embed** - Integração de vídeos dos animais
